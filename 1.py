...
def draw_piston_and_connecting_rod(piston_y):
    ...
    pygame.draw.rect(screen, piston_color, (380, piston_y, 40, 150))
    pygame.draw.rect(screen, background_color, (390, piston_y + 10, 20, 10))
    
    # Dibuja la biela conectada al pistón
    piston_center = (400, piston_y + 75)
    pygame.draw.line(screen, connecting_rod_color, (400, piston_y + 75), (400, piston_y + 225), 10)
