...
crankshaft_angle = 0
piston_speed = 1  # Velocidad de movimiento del pistón más lenta
...
def draw_piston_and_connecting_rod(piston_x, piston_y, circle_center_x, circle_center_y):
    ...
    piston_center = (piston_x + 20, piston_y + 75)
...
while running:
    ...
    piston_position_y = 300 + 100 * math.sin(crankshaft_angle)  # Movimiento vertical
    ...
    if frame_count > state_duration:
        ...
        if current_state == ADMISSION:
            ...
            if piston_position_y >= 250 + piston_length:  # Ajusta el valor apropiado según la posición del pistón
                valve_exhaust_open = True
            else:
                valve_exhaust_open = False
        else:
            current_state = ADMISSION
